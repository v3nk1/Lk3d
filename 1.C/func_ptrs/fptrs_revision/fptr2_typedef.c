...
typedef void (*ret_func)( int , char ); 
		// we need to declare it. we cannt use previous one becoz func has the 		\
		signature that it takes 2 int and return int. Now here ret_func takes 		\
		int & char as arguments and nothing return.
