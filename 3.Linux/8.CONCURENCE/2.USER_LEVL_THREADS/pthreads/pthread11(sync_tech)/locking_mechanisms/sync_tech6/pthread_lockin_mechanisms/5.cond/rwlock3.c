//pthread_rdwrlock: problem(writer starvation)..
	//here in this prog writer2(thread) suffers with writer-starvation problem.. becoz writer2 will block until and unless reder-thread's complete their job of reading the data.. called writer starvation..
		//here we hav given 2 sleeps(20) here in reader(1and2) for observation of waiting of writer2.. so writer will block for 40 sec and then unblock and update a = 10000 and b = 20000.
