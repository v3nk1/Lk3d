...
* Vital statistics:
  ...
  Alignment:                              2 * sizeof(size_t) (default)
       (i.e., 8 byte alignment with 4byte size_t). This suffices for			//see "vi ./size_t.c"
  ...
  Minimum allocated size: 4-byte ptrs(32bit):  16 bytes    (including 4 overhead)
			  8-byte ptrs(64bit):  24/32 bytes (including, 4/8 overhead)
